...
# Rake tasks for permission management - uses AuthorizationService for implementation
namespace :permissions do
  desc "Discover and seed permissions from controllers"
  task discover: :environment do
    puts "Discovering permissions from controllers..."
    
    # Use the AuthorizationService to discover permissions
    count = AuthorizationService.refresh_permissions
